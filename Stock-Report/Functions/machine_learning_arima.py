...
def arima_prediction(ticker, test_percent=0.8):
...
#         training_df['Actual Price'][0]
    ...
    train_mse = np.sqrt(mean_squared_error(train_predictions['Actual Price'],
                                           train_predictions['Predicted Price'].values))
    # print(training_df)
    print(train_predictions.index)
    print(train_mse)
    return forecast
